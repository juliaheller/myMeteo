...
export default function Header({clickStats}) {
  ...
  return (
      ...
      <div className = "button-statitics"><svg onClick = {() => clickStats()}>
      <image className = "navbarIcon" xlinkHref = {statisticIcon}>
      </image>
          </svg></div>
      </div><Toolbar variant = "dense">
      <div className = {classes.title}><Link exact = "true" to = "/home">
